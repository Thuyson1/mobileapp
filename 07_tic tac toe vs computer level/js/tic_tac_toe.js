...
const lineRamdom = cornerLine(squaresArray, ["a_1","a_3","c_1","c_3"]);
let winningLine = null;

const msgtxt1 = '<p class="image"><img src ="img/penguins.jpg" width=61px height=61px></p><p class="text">Pengins Attack! your turn</p>';
...
const msgtxt5 ='<p class="image"><img src ="img/penguins.jpg" width=61px height=61px><img src ="img/whitebear.jpg" width=61px height=61px></p></p><p class="text animate__bounceIn">Draw!!</p>';
...
newgamebtn.addEventListener("click", function () {
    ...
    squaresArray.forEach(function (square) {
        ...
        square.classList.remove("js-pen_hightLight");
